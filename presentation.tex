...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item \focus{Spla}: sparse-linear-algebra-based graph analysis library that uses OpenCL
...
\begin{frame}
  \frametitle{Memory Lock Arbiters}
  \begin{center}
  \includegraphics[width=0.45\textwidth]{pictures/amounit2.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item SPLA: \url{https://github.com/SparseLinearAlgebra/spla}
  \end{itemize}
  Other Pull Requests:
  \begin{itemize}
