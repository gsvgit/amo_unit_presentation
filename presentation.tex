...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item Spla is a sparse linear algebra library that uses OpenCL
    \item Our goal is to run this library on Vortex and conduct experiments
    \item In the RTL design, support for extension RISC-V A was missing
    \item Support for these operations was added in PoCL
    \item Our solution is not optimal, as our goal was simply to make it work and be able to run SPLA on an FPGA
    \item A solution was developed that is currently under active development
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Memory Lock Arbiters}
  \begin{center}
  \includegraphics[width=0.8\textwidth]{pictures/arbiters.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Three register arrays of size SIMD\_WIDTH are used to track the reservation: reservation validity, address, and data
  \end{itemize}
\end{frame}
